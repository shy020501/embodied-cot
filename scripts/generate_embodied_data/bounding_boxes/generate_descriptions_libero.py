...
# # ✅ Load LIBERO TFDS
# ds = tfds.load(
#     name="libero_lm_90",  # TFDS 내부 name
...
for episode in tqdm(ds):
    ...
    for step in episode["steps"]:
        ...
        image = Image.fromarray(step["observation"]["image"].numpy())  # ✅ LIBERO의 image key
    ...
    results_json[file_path][int(demo_id)] = episode_json
